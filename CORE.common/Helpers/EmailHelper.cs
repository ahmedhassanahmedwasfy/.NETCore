...
namespace CORE.common.Helpers
{
    public class EmailHelper
    {
        ...
        public EmailHelper(IOptions<EmailOptions> EmailOptions)
        {
            ...
            smtpClient.Host = _EmailOptions.smtpHost; //Configure as your email provider
            smtpClient.UseDefaultCredentials = false;
            smtpClient.EnableSsl = Convert.ToBoolean(_EmailOptions.EnableSsl);//comment if you don't need SSL 
            smtpClient.Credentials = new NetworkCredential(_EmailOptions.userName, _EmailOptions.password);
            smtpClient.DeliveryMethod = SmtpDeliveryMethod.Network;
            FromAddress = new MailAddress(_EmailOptions.From);
            smtpClient.Port = Convert.ToInt32(_EmailOptions.port);
            Message = new MailMessage();
        }
        //protected EmailHelper(string host, int port, string userName, string password, bool ssl)
        //: this( )
        //{
